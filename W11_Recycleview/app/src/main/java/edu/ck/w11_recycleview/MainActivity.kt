...
import edu.ck.w11_recycleview.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) { // called when device is rotated
        ...
        if (savedInstanceState == null){        // FRESH START: fetch randomized arrays
            ...
            adapter = RecyclerAdapter(viewModel.save2dArr[0],viewModel.save2dArr[1],viewModel.save2dArr[2]) // use restored arrays to create adapter
    ...
    /*
    // solid explanation of when/how to use onSaveInstanceState
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        /*
        for (b in outState.keySet()){
            Log.i(TAG,"FISH "+ b + " is a key in the bundle")
        }
        */
        val fName = object{}.javaClass.enclosingMethod.name
        Log.i(TAG,"\n#$fName outState = " + outState)
    }
    ...
    override fun onRestoreInstanceState(savedInstanceState: Bundle) {
        ...
        viewModel.getState()
        val fName = object{}.javaClass.enclosingMethod.name
        Log.i(TAG,"\n######\n$fName savedInstanceState = " + savedInstanceState)
    }
    */
